...
const resolveApiUrl = () => {
  ...
  // Use Google Gemini's native OpenAI-compatible API endpoint
...
export async function invokeLLM(params: InvokeParams): Promise<InvokeResult> {
  ...
  // Strip "gemini/" prefix if talking directly to Google AI Studio endpoint
  payload.model = apiUrl.includes("generativelanguage.googleapis.com")
    ? rawModel.replace(/^gemini\//, "")
    : rawModel;
